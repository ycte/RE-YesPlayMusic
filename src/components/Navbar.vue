  ...
  <div>
    <nav :class="{ 'has-custom-titlebar': hasCustomTitlebar }">
      ...
      <div class="navigation-buttons">
        <button-icon @click="go('back')" v-show="showBack">
          <!-- <svg-icon icon-class="arrow-left" /> -->
          <q-icon :name="ionChevronBackOutline" class="svg-icon"></q-icon>
        </button-icon>
...
// 为什么 vuex 跟 pinia 差这么多🤐🤐🤐🤪🤪🤪
// 为什么 vuex 跟 pinia 差这么多🤐🤐🤐🤪🤪🤪
// 为什么 vue 2 跟 vue 3 差这么多🤐🤐🤐🤪🤪
// 为什么 vue 3 跟 vue 2 差这么多🤐🤐🤐🤪🤪
// 为什么 .native 跟 Fliter deprecated 了🤐🤐🤐🤪
// 为什么 Fliter 跟 .native deprecated 了🤐🤐🤐🤪

// import { isLooseLoggedIn, doLogout } from "src/utils/auth";

// import icons for win32 title bar
// icons by https://github.com/microsoft/vscode-codicons
// import "vscode-codicons/dist/codicon.css";

// import Win32Titlebar from 'src/components/Win32Titlebar.vue';
// import LinuxTitlebar from 'src/components/LinuxTitlebar.vue';
// import ContextMenu from 'src/components/ContextMenu.vue';
import ButtonIcon from "src/components/ButtonIcon.vue";
import { ionChevronBackOutline } from "@quasar/extras/ionicons-v7";
