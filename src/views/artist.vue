  ...
  <div v-show="show" class="artist-page">
    <div class="artist-info">
      ...
      <div>
        ...
        <div class="statistics">
          <a srcclick="scrollTo('popularTracks')"
            >{{ artist.musicSize }} {{ $t("common.songs") }}</a
          >
          ·
          <a srcclick="scrollTo('seeMore', 'start')"
            >{{ artist.albumSize }} {{ $t("artist.withAlbums") }}</a
          >
          ·
          <a srcclick="scrollTo('mvs')"
            >{{ artist.mvSize }} {{ $t("artist.videos") }}</a
          >
        </div>
        <div class="description" srcclick="toggleFullDescription">
          {{ artist.briefDesc }}
        </div>
        <div class="buttons">
          <ButtonTwoTone icon-class="play" srcclick.native="playPopularSongs()">
            {{ $t("common.play") }}
          </ButtonTwoTone>
          <ButtonTwoTone color="grey" srcclick.native="followArtist">
    ...
    <div v-if="latestRelease !== undefined" class="latest-release">
      ...
      <div class="release">
        ...
        <div v-show="latestMV.id" class="container latest-mv">
          <div
            class="cover"
            srcmouseover="mvHover = true"
            srcmouseleave="mvHover = false"
            srcclick="goToMv(latestMV.id)"
          >
    ...
    <div id="popularTracks" class="popular-tracks">
      ...
      <div id="seeMore" class="show-more">
        <button srcclick="showMorePopTracks = !showMorePopTracks">
...
import MvRow from "src/components/MvRow.vue";
