  ...
  <div v-show="show" class="album-page">
    <div class="playlist-info">
      <Cover
        ...
        :cover-hover="false"
        :play-button-size="18"
        srcclick.right.native="openMenu"
      />
      <div class="info">
        <div class="title" srcclick.right="openMenu">{{ title }}</div>
        <div v-if="subtitle !== ''" class="subtitle" srcclick.right="openMenu">
          {{ subtitle }}
        </div>
        <div class="artist">
        ...
        <div class="buttons" style="margin-top: 32px">
          <ButtonTwoTone
            icon-class="play"
            srcclick.native="playAlbumByID(album.id)"
          >
            {{ $t("common.play") }}
          </ButtonTwoTone>
          <ButtonTwoTone
    ...
    <ContextMenu ref="albumMenu">
      ...
      <div class="item" srcclick="copyUrl(album.id)">
